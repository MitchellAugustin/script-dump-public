...
EMBEDDED_SUBMODULES="CryptoPkg/Library/OpensslLib CryptoPkg/Library/OpensslLib/openssl ArmPkg/Library/ArmSoftFloatLib/berkeley-softfloat-3 MdeModulePkg/Library/BrotliCustomDecompressLib/brotli"
#EMBEDDED_SUBMODULES="CryptoPkg/Library/OpensslLib/openssl ArmPkg/Library/ArmSoftFloatLib/berkeley-softfloat-3"
...
do_build() {
    ...
    #build -a X64 -t ${TOOLCHAIN} -p OvmfPkg/OvmfPkgX64.dsc -DHTTP_BOOT_ENABLE=FALSE -DFD_SIZE_2MB -DNETWORK_IP6_ENABLE=TRUE -DNETWORK_TLS_ENABLE -DSECURE_BOOT_ENABLE=FALSE -b RELEASE -DTPM_ENABLE=TRUE -DSMM_REQUIRE=TRUE
}
cd edk2
